...
def intersection(nO_states,states,alphabet_size,alphabet,transition_function,start_state,nO_final_states,final_states,nO_states1,states1,alphabet_size1,alphabet1,transition_function1,start_state1,nO_final_states1,final_states1):
	#works out the intersection of 2 DFA's
	...
	for j in range(new_nO_states):
		if new_states[j][0] in final_states and new_states[j][1] in final_states1:
